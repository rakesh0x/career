...
export class TamboAIService {
  ...
  static async processInput(input: string): Promise<TamboResponse> {
    ...
    // Default response: show all Tambo components
    return {
      ...
      actions: [
        ...
        },
        {
          ...
          props: {
            skills: [
              { name: 'Communication', level: 'intermediate', proficiency: 60 },
              { name: 'Problem Solving', level: 'beginner', proficiency: 40 },
              { name: 'Teamwork', level: 'advanced', proficiency: 80 },
            ],
          },
          position: 'bottom',
        },
        {
          ...
          props: {
            gaps: [
              { skill: 'Leadership', currentLevel: 30, requiredLevel: 70, gapSize: 40 },
              { skill: 'Technical Writing', currentLevel: 50, requiredLevel: 80, gapSize: 30 },
            ],
          },
          position: 'bottom',
        },
        {
          ...
          props: {
            milestones: [
              { title: 'Start Learning', description: 'Begin with basics', timeframe: 'Month 1', status: 'upcoming' },
              { title: 'Build Projects', description: 'Apply skills in real projects', timeframe: 'Month 2-4', status: 'upcoming' },
            ],
          },
          position: 'bottom',
        },
        {
          ...
          props: {
            roles: [
              { title: 'Junior Developer', fitScore: 60, description: 'Entry-level dev role', matchedSkills: ['Communication', 'Teamwork'] },
              { title: 'Project Coordinator', fitScore: 50, description: 'Assist in project management', matchedSkills: ['Organization', 'Teamwork'] },
            ],
          },
          position: 'bottom',
        },
        {
          ...
          props: {
            resources: [
              { title: 'Effective Communication', type: 'course', provider: 'Coursera', description: 'Improve communication skills', estimatedTime: '10 hours', relevance: 'high' },
              { title: 'Teamwork Skills', type: 'article', provider: 'Harvard Business Review', description: 'Best practices for teamwork', estimatedTime: '1 hour', relevance: 'medium' },
            ],
          },
          position: 'bottom',
        },
